...
def simplified_quantum_counting(x):
    ...
    # The additional factor was added to expand the range of theta in [theta_min, theta_max] as the original
    # algorithm requires to many qubits to simulate efficiently.
